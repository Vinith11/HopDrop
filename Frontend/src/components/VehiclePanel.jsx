...
const VehiclePanel = (props) => {
    ...
    useEffect(() => {
        if (props.fare && (props.fare.car || props.fare.moto || props.fare.auto)) {
            setIsLoading(false);
        }
    }, [props.fare]);
        ...
        return (
            <div className="p-4 bg-white rounded-t-3xl shadow-lg">
                ...
                <div className="space-y-4">
                    {[1, 2, 3].map((index) => (
                        <div key={index} className="animate-pulse flex border-2 mb-2 rounded-xl w-full p-3 items-center justify-between">
